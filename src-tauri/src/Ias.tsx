...
/* ================================= IAs =================================
   ...
   quem instalou (assinatura do Claude, ChatGPT no Codex, conta Google no
   Gemini…). Conectar = instalar a CLI e logar; esta tela só mostra o estado
   e dá o comando pra copiar. */
    ...
    <div className="min-h-0 flex-1 overflow-y-auto">
      <div className="mx-auto w-full max-w-[62rem] px-8 py-10">
        ...
        <div className="mt-8 flex items-start gap-2.5 rounded-xl border border-hairline p-4">
          <span className="mt-0.5 text-ink-dim">
